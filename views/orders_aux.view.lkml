view: orders_aux {
  sql_table_name: `hackathon-inovamos.hackathon_inovamos.orders_aux`
    ;;
  ...
  measure: count {
    type: count
    drill_fields: [stores.store_id, stores.store_name, orders.order_id, channels.channel_name, channels.channel_id]
  }
}
